...
public class PassengerSignInActivity extends AppCompatActivity {
    ...
    private Button passengerLoginSignUp;
    ...
    private void fieldsBinding() {
        ...
        passengerLoginSignUp = findViewById(R.id.driverLoginSignUp);
        toggleLoginSignUpTextView = findViewById(R.id.toggleLoginSignUpTextView);
        passengerLoginSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
